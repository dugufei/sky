...
class SkConsts {
	...
	static final String		NAME_PROVIDERS				= "_Providers";

	static final String		NAME_LIBRARY_PROVIDERS		= "_SKDILibrary_Providers";

	static final String		NAME_LIBRARY_PROVIDERS_OPEN	= "_SKDILibrary_Providers_Open";
	...
	static final ClassName	SK_DEFAULT_PROVIDER			= ClassName.get(FACADE_PACKAGE, "SKDefaultProvider");

	static final ClassName	SK_COMMOM_PROVIDER			= ClassName.get(FACADE_PACKAGE, "SKCommonClassProviders");
