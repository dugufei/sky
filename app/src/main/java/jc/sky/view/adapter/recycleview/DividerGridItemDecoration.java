...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
	...
	@Override public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
		...
		if (!islastRaw && isLastRaw(parent, itemPosition, spanCount, childCount))// 如果是最后一行，则不需要绘制底部
		{
	...
	public void setShowLastRaw(boolean islastRaw) {
		this.islastRaw = islastRaw;
	}
}