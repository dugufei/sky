 ...
 * @see SKYFooterOnScrollListener 滑动监听
 */
public class SKYFooterOnScrollListener extends RecyclerView.OnScrollListener {

	public SKYFooterOnScrollListener(SKYFooterListener footerListener) {
		this.footerListener = footerListener;
	}

	public void setRecyclerviewSKYRefreshListener(SKYFooterListener footerListener) {
		this.footerListener = footerListener;
	}
