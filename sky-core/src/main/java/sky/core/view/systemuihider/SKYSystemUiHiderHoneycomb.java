package sky.core.view.systemuihider;
...
public class SKYSystemUiHiderHoneycomb extends SKYSystemUiHider {
	...
	@TargetApi(Build.VERSION_CODES.JELLY_BEAN) protected SKYSystemUiHiderHoneycomb(AppCompatActivity activity, View anchorView, int flags) {
