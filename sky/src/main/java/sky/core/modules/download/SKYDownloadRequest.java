...
public class SKYDownloadRequest extends SKYBaseRequest {
	 ...
	 * 下载事件
	 */
	private sky.core.modules.download.SKYDownloadListener SKYDownloadListener;
	 ...
	 * @return 事件
	 */
	public sky.core.modules.download.SKYDownloadListener getSKYDownloadListener() {
	 ...
	 * @return 返回值
	 */
	public SKYDownloadRequest setSKYDownloadListener(sky.core.modules.download.SKYDownloadListener SKYDownloadListener) {
