...
public final class SKPreconditions {
	 ...
	 *            message is formed by replacing the single {@code %s} placeholder
	 *            in the template with {@code errorMessageArg}.
	 * @param errorMessageArg
	 *            the argument to be substituted into the message template.
	 *            Converted to a string using {@link String#valueOf(Object)}, except
	 *            for {@link Class} objects, which use
	 *            {@link Class#getCanonicalName()}.
	 * @return the non-null reference that was validated
	 * @throws NullPointerException
	 *             if {@code reference} is null
	 * @throws IllegalArgumentException
	 *             if {@code errorMessageTemplate} doesn't contain exactly one "%s"
	 */
