...
public class SKViewModelProvider {
	...
	private final androidx.lifecycle.SKViewModelStore mViewModelStore;

	public SKViewModelProvider(@NonNull androidx.lifecycle.SKViewModelStoreOwner owner, @NonNull SKViewModelProvider.Factory factory) {
		this(owner.getSKViewModelStore(), factory);
	}

	public SKViewModelProvider(@NonNull androidx.lifecycle.SKViewModelStore store, @NonNull SKViewModelProvider.Factory factory) {
		mFactory = factory;
